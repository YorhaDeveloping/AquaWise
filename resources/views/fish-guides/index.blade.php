    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        <div class="md:flex md:items-center md:justify-between mb-6 px-4 sm:px-0">
            <div class="flex-1 min-w-0">
                <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:text-3xl sm:truncate">Fish Guides</h2>
                <p class="mt-1 text-sm text-gray-500">Browse through our collection of fish guides created by experts.</p>
            </div>
            ...
            <div class="mt-4 flex md:mt-0 md:ml-4">
                <a href="{{ route('fish-guides.disabled') }}" class="w-full md:w-auto inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 ml-2">
                    View Disabled Guides
                </a>
            </div>
            @endif
        </div>
        ...
        <div class="bg-white shadow sm:rounded-lg mb-6">
            <div class="px-4 py-5 sm:p-6">
                <form action="{{ route('fish-guides.index') }}" method="GET" class="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-4">
                    <div class="w-full">
            ...
            <ul role="list" class="divide-y divide-gray-200">
                        ...
                        <div class="px-4 py-4 sm:px-6">
                            ...
                            <div class="mt-2 sm:flex sm:justify-between">
                                ...
                                <div class="mt-2 flex items-center space-x-4 text-sm text-gray-500 sm:mt-0">
                                    ...
                                    @if(Auth::user()->hasRole('admin') && $guide->status !== 'disabled')
                ...
                <li class="px-4 py-6 sm:px-6">
                    <div class="text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">No fish guides found</h3>
                        <p class="mt-1 text-sm text-gray-500">
                            @if(request('search'))
                                Try adjusting your search criteria.
                            @else
                                Get started by creating a new fish guide.
                            @endif
                        </p>
                        @if(Auth::user()->hasRole('expert'))
                        <div class="mt-6">
